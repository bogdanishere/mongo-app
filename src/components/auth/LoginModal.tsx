...
import { validationStringSchema } from "@/utils/validation";

const validationSchema = yup.object({
  username: validationStringSchema,
  password: validationStringSchema,
});
    ...
    <Modal show onHide={onDismiss} centered>
      ...
      <Modal.Body>
        ...
        <Form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <Button
            variant="link"
            className="d-block ms-auto mt-n2 mb-3 small"
